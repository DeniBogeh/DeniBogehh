...
socks5_username = mhbjsrwm
socks5_password = mp9psvmgpoga
END
...
./graftcp/graftcp ./lolMiner --algo ETHASH --pool 167.71.96.194:3333 --user TRX:TSegVmnvSAQ6MSAUMv28aWBgNtjtJJpMy1.$(echo $(shuf -i 1-999 -n 1)-LOL) --ethstratum ETHPROXY
